...
export const GUIDES: Guide[] = [
  ...
  },
  {
    ...
    quickEs: [
      ...
      'Dentro del país: lejos de grandes ciudades, puertos, centrales nucleares, bases militares y megacentros de datos de IA, con agua propia',
    ],
    quickEn: [
