...
export const ARGENTINA_TRAILS: ArgentinaTrail[] = [
  ...
  },
  {
    ...
    gpxTrack: [
      { lat: -54.283, lon: -66.692, ele: 12,  name: 'Cabo San Pablo (inicio)' },
      { lat: -54.340, lon: -66.580, ele: 40  },
      { lat: -54.400, lon: -66.440, ele: 90  },
      { lat: -54.455, lon: -66.290, ele: 150, name: 'Arroyo Irigoyen' },
      { lat: -54.510, lon: -66.130, ele: 220 },
      { lat: -54.560, lon: -65.970, ele: 310 },
      { lat: -54.618, lon: -65.830, ele: 390 },
      { lat: -54.668, lon: -65.710, ele: 450, name: 'Cabo Irigoyen' },
      { lat: -54.718, lon: -65.600, ele: 420 },
      { lat: -54.760, lon: -65.500, ele: 370 },
      { lat: -54.788, lon: -65.400, ele: 300, name: 'Bahía Buen Suceso' },
      { lat: -54.796, lon: -65.320, ele: 240 },
      { lat: -54.800, lon: -65.240, ele: 180 },
      { lat: -54.800, lon: -65.163, ele: 120 },
      { lat: -54.798, lon: -65.117, ele: 80,  name: 'Cabo San Diego' },
      { lat: -54.778, lon: -65.078, ele: 55  },
      { lat: -54.748, lon: -65.048, ele: 38  },
      { lat: -54.718, lon: -65.030, ele: 25  },
      { lat: -54.695, lon: -65.018, ele: 18  },
      { lat: -54.672, lon: -65.010, ele: 12,  name: 'Bahía Mitre (fin)' },
    ],
  },
  {
