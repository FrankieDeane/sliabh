...
export const ARGENTINA_TRAILS: ArgentinaTrail[] = [
  ...
  },
  {
    ...
    gpxTrack: [
      { lat: -54.07, lon: -66.36, ele: 15,  name: 'Cabo San Pablo (inicio)' },
      { lat: -54.12, lon: -66.27, ele: 38  },
      { lat: -54.18, lon: -66.16, ele: 120 },
      { lat: -54.24, lon: -66.05, ele: 210, name: 'Puerto San Pablo' },
      { lat: -54.30, lon: -65.96, ele: 310 },
      { lat: -54.35, lon: -65.87, ele: 390 },
      { lat: -54.40, lon: -65.79, ele: 450 },
      { lat: -54.44, lon: -65.73, ele: 420, name: 'Cabo Peñas' },
      { lat: -54.48, lon: -65.67, ele: 380 },
      { lat: -54.52, lon: -65.63, ele: 330 },
      { lat: -54.55, lon: -65.59, ele: 270 },
      { lat: -54.58, lon: -65.56, ele: 210 },
      { lat: -54.61, lon: -65.53, ele: 160 },
      { lat: -54.64, lon: -65.51, ele: 130 },
      { lat: -54.67, lon: -65.50, ele: 100 },
      { lat: -54.70, lon: -65.49, ele: 80  },
      { lat: -54.73, lon: -65.49, ele: 60  },
      { lat: -54.76, lon: -65.50, ele: 45  },
      { lat: -54.79, lon: -65.52, ele: 30  },
      { lat: -54.82, lon: -65.51, ele: 20,  name: 'Bahía Mitre (fin)' },
    ],
  },
  {
