...
export const ARGENTINA_TRAILS: ArgentinaTrail[] = [
  ...
  },
  {
    ...
    gpxTrack: [
      { lat: -54.170, lon: -65.930, ele:  10, name: 'Cabo San Pablo (inicio)' },
      { lat: -54.250, lon: -65.860, ele:  35 },
      { lat: -54.340, lon: -65.780, ele:  80, name: 'Arroyo Irigoyen' },
      { lat: -54.430, lon: -65.700, ele: 130 },
      { lat: -54.520, lon: -65.620, ele: 190 },
      { lat: -54.600, lon: -65.540, ele: 240 },
      { lat: -54.660, lon: -65.460, ele: 290, name: 'Cabo Irigoyen' },
      { lat: -54.720, lon: -65.390, ele: 260 },
      { lat: -54.780, lon: -65.310, ele: 220 },
      { lat: -54.820, lon: -65.270, ele: 160, name: 'Bahía Buen Suceso' },
      { lat: -54.825, lon: -65.200, ele: 120 },
      { lat: -54.815, lon: -65.130, ele:  80 },
      { lat: -54.800, lon: -65.115, ele:  55, name: 'Cabo San Diego' },
      { lat: -54.778, lon: -65.070, ele:  40 },
      { lat: -54.755, lon: -65.030, ele:  28 },
      { lat: -54.730, lon: -65.005, ele:  18 },
      { lat: -54.700, lon: -64.990, ele:  12, name: 'Bahía Mitre (fin)' },
    ],
  },
  {
