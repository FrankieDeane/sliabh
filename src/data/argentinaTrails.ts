...
export const ARGENTINA_TRAILS: ArgentinaTrail[] = [
  ...
  },
  {
    ...
    gpxTrack: [
      { lat: -54.093, lon: -66.172, ele: 12,  name: 'Cabo San Pablo (inicio)' },
      { lat: -54.120, lon: -66.093, ele: 35  },
      { lat: -54.165, lon: -66.018, ele: 80  },
      { lat: -54.203, lon: -65.940, ele: 130, name: 'Arroyo Irigoyen' },
      { lat: -54.255, lon: -65.870, ele: 200 },
      { lat: -54.305, lon: -65.800, ele: 280 },
      { lat: -54.348, lon: -65.735, ele: 360 },
      { lat: -54.390, lon: -65.672, ele: 430 },
      { lat: -54.430, lon: -65.628, ele: 450, name: 'Bahía Valentín' },
      { lat: -54.458, lon: -65.588, ele: 400 },
      { lat: -54.485, lon: -65.530, ele: 340 },
      { lat: -54.510, lon: -65.470, ele: 280, name: 'Cabo Irigoyen' },
      { lat: -54.540, lon: -65.405, ele: 220 },
      { lat: -54.572, lon: -65.348, ele: 170 },
      { lat: -54.605, lon: -65.295, ele: 130 },
      { lat: -54.638, lon: -65.258, ele: 95  },
      { lat: -54.665, lon: -65.228, ele: 70,  name: 'Cabo San Diego' },
      { lat: -54.690, lon: -65.172, ele: 50  },
      { lat: -54.710, lon: -65.112, ele: 35  },
      { lat: -54.722, lon: -65.053, ele: 20,  name: 'Bahía Mitre (fin)' },
    ],
  },
  {
