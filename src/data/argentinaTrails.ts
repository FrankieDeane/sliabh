...
export const ARGENTINA_TRAILS: ArgentinaTrail[] = [
  ...
  },
  {
    ...
    coordinates: { lat: -54.2793, lon: -68.0272 },
    ...
    gpxTrack: [
      { lat: -54.3020, lon: -68.2030, ele: 200,  name: 'Trailhead — Camping Las Cotorras' },
      { lat: -54.3100, lon: -68.1750, ele: 350 },
      { lat: -54.2980, lon: -68.1420, ele: 600 },
      { lat: -54.2850, lon: -68.1180, ele: 820,  name: 'Paso de la Oveja (940 m)' },
      { lat: -54.2700, lon: -68.0800, ele: 750 },
      { lat: -54.2600, lon: -68.0500, ele: 650,  name: 'Valle Andorra' },
      { lat: -54.2500, lon: -68.0100, ele: 900 },
      { lat: -54.2400, lon: -67.9700, ele: 1100, name: 'Paso Valdivieso (1190 m)' },
      { lat: -54.2550, lon: -67.9300, ele: 850 },
      { lat: -54.2750, lon: -67.9100, ele: 600,  name: 'Laguna Carbajal' },
      { lat: -54.2950, lon: -67.9400, ele: 400 },
      { lat: -54.3100, lon: -67.9900, ele: 250,  name: 'Valle Carbajal' },
      { lat: -54.3150, lon: -68.0800, ele: 220 },
      { lat: -54.3020, lon: -68.2030, ele: 200,  name: 'Regreso — Camping Las Cotorras' },
    ],
  },
];
