...
const NATIONAL_PARKS = [
  ...
  },
  {
    ...
    trailId: 'bahia-mitre',
    gpxPoints: [
      { lat: -54.9050, lon: -67.6200, name: 'Bahía Mitre — Inicio / punto de extracción oeste' },
      { lat: -54.8850, lon: -67.4100, name: 'Río Overand — cruce vadera' },
      { lat: -54.8850, lon: -67.3000, name: 'Paso Sierra Beauvoir (510 m)' },
      { lat: -54.9124, lon: -67.0497, name: 'Bahía Aguirre — Campamento costero' },
      { lat: -54.8900, lon: -66.8600, name: 'Río San Pablo — cruce' },
      { lat: -54.9000, lon: -66.6200, name: 'Río Cangrejo — cruce vadera' },
      { lat: -54.9050, lon: -66.4400, name: 'Bahía Sloggett' },
      { lat: -54.9000, lon: -66.3500, name: 'Río Ewan — cruce vadera' },
      { lat: -54.8700, lon: -66.0800, name: 'Desembocadura Río Grande' },
      { lat: -54.8500, lon: -65.6700, name: 'Cabo San Diego — Punta más oriental de Argentina' },
    ],
  },
  {
    id: 'tierradelfuego',
