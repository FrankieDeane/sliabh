...
const NATIONAL_PARKS = [
  ...
  },
  {
    ...
    trailId: 'bahia-mitre',
    gpxPoints: [
      { lat: -54.0920, lon: -65.4310, name: 'Cabo San Pablo — Inicio' },
      { lat: -54.1800, lon: -65.2200, name: 'Bahía Thetis' },
      { lat: -54.4200, lon: -65.1100, name: 'Punta noreste' },
      { lat: -54.6500, lon: -65.1200, name: 'Cabo San Diego — Punta más oriental de Argentina' },
      { lat: -54.7900, lon: -65.2400, name: 'Costa rocosa este' },
      { lat: -54.8500, lon: -65.3800, name: 'Bahía Sloggett' },
      { lat: -54.9100, lon: -65.9200, name: 'Río Ewan — Cruce vadera' },
      { lat: -54.9000, lon: -66.1000, name: 'Bahía Buen Suceso' },
      { lat: -54.8900, lon: -66.4500, name: 'Cruce Río Cangrejo' },
      { lat: -54.8750, lon: -66.8000, name: 'Paso Sierra Sorondo (340 m)' },
      { lat: -54.9124, lon: -67.0497, name: 'Bahía Aguirre — Sector costa' },
      { lat: -54.9100, lon: -67.2200, name: 'Río Lasifashaj — Cruce' },
      { lat: -54.8900, lon: -67.3800, name: 'Paso Sierra Beauvoir (510 m)' },
      { lat: -54.8800, lon: -67.5700, name: 'Playa Bahía Mitre Este' },
      { lat: -54.9100, lon: -67.6300, name: 'Bahía Mitre — Fin / punto de extracción' },
    ],
  },
  {
    id: 'tierradelfuego',
